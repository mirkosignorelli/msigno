...
The functions are embedded in a (simple and minimalist) R package. A couple of these functions (pmf, make.spaghetti) are also available in the [https://github.com/m-signo/ptmixed](ptmixed package) that can be downloaded from CRAN.
